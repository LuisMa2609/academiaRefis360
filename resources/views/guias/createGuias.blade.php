...
<div class="container">
    ...
    <h1 class="text-center">Crear nueva guía</h1>
    <div class="container bg-white shadow rounded py-3 px-3 mb-4 border-top border-warning border-3">
        <form method="POST" action="{{route('guias.store')}}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="urlvideo" type="text" class=" form-control @error('urlvideo') is-invalid @enderror" name="urlvideo" value="{{ old('urlvideo') }}" required autocomplete="urlvideo" autofocus>
                        @error('urlvideo')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="urlpdf" type="text" class=" form-control @error('urlpdf') is-invalid @enderror" name="urlpdf" value="{{ old('urlpdf') }}" required autocomplete="urlpdf" autofocus>
                        @error('urlpdf')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
